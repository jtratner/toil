...
class GoogleJobStore(AbstractJobStore):
    ...
    def writeSharedFileStream(self, sharedFileName, isProtected=True):
        ...
        try:
            ...
            if isProtected:
                # boto has issues, see self._writeFile for more
                pass
            else:
                raise
    ...
    def _getKey(self, jobStoreID=None, headers=None):
        ...
        try:
            ...
            pass  # see self._writeFile for more
        if key is None:
    ...
    def _writeFile(self, jobStoreID, fileObj, update=False, encrypt=True):
        ...
        try:
            ...
            # -supplied_encryption_keys the etag and md5 will not match with customer supplied
    ...
    def _writeString(self, jobStoreID, stringToUpload, update=False, encrypt=True):
        self._writeFile(jobStoreID, StringIO(stringToUpload), update=update, encrypt=encrypt)
                ...
                def writer():
                    ...
                    if update:
                        ...
                        try:
                            ...
                            # generation (version) before modifying anything. if_generation=0
                            # insures key does not exist remotely
